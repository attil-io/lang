...
(defn interpret [code] 
	(let [parsed (parse_parse_toplevel code)
		...
		global_env (environment_def "printenv" printenvimpl (environment_def "println" printlnimpl (environment_def "print" printimpl (environment_def "print_accum" [] empty_env))))
