(ns lang.environment-test
 ...
 (deftest environment-test
  (testing "test environment_create"
    (is (= {:vars {} :parent nil :closure {}} (environment_create nil)))
    (is (= {:vars {} :parent {:vars nil :parent nil} :closure{}} (environment_create {:vars nil :parent nil})))
    (is (= {:vars {} :parent {:vars {:var1 "val1"} :parent nil} :closure{}} (environment_create {:vars {:var1 "val1"} :parent nil}))))
  ...
  (testing "test environment_get"
    ...
    (is (= 42 (environment_get "hello" {:vars {} :closure {:hello 42} :parent nil})))
  ...
  (testing "test environment_def_closure"
    (is (= {:vars {} :parent nil :closure {:hello 42}} (environment_def_closure "hello" 42 {:vars {} :parent nil :closure {}}))))
  (testing "test environment_def_closure_more"
    (is (= {:vars {} :parent nil :closure {:hello 42 :world 100}} (environment_def_closure_more ["hello" "world"] [42 100] {:vars {} :parent nil :closure {}})))))
